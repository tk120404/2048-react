...
var BoardView = React.createClass({
  ...
  render: function () {
    ...
    return (
      <div className={boardClasses} onTouchStart={this.handleTouchStart} onTouchEnd={this.handleTouchEnd} tabIndex="1">
        {cells}
        {tiles}
  ...
  render: function () {
    ...
    return (
      <div className={scoreClasses}>
        <p className='message'>{contents}</p>
        <button className="tryAgain" onClick={this.props.onRestart} onTouchEnd={this.props.onRestart}>New Game</button>
        <select valueLink={valuelink} className="matrix">
